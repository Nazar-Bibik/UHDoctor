                ...
                VStack{
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack(spacing: 32){
                            ...
                            BarChartView(data: ChartData(values: UserDefaults.standard.dictionary(forKey: "G31").map{ (key: String, value: Int) in return (key, value) } as! [(String, Int)]), title: "Patients data", legend: "Age")
